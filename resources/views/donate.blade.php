...
<body>
    ...
    <button class="accordion">Instruksi</button>
    <div class="panel">
        <div class="instruksi">
    ...
    <button class="accordion">QRIS</button>
    <div class="panel">
        <div class="qris">
            <h2>Scan QR di bawah ini: </h2>
            <img src="{{ asset('assets/qris.jpeg') }}" alt="QRIS" class="qris-image">
            
        </div>
    </div>
    <form class="donatebtn" action="{{ route('donate.store', ['orph_id' => $orphanage->id]) }}" method="POST">
                @csrf
